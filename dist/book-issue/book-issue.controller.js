...
const create_book_issue_dto_1 = require("./dto/create-book-issue.dto");
let BookIssueController = class BookIssueController {
    constructor(bookIssueService) {
        this.bookIssueService = bookIssueService;
    }
    create(createBookIssueDto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_book_issue_dto_1.CreateBookIssueDto]),
